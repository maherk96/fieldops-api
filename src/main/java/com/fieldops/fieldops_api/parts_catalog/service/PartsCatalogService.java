...
public class PartsCatalogService {
    ...
    public PartsCatalogService(final PartsCatalogRepository partsCatalogRepository,
    ...
    public PartsCatalogDTO get(final UUID id) {
        return partsCatalogRepository.findById(id)
                .map(partsCatalog -> mapToDTO(partsCatalog, new PartsCatalogDTO()))
    ...
    public void update(final UUID id, final PartsCatalogDTO partsCatalogDTO) {
        final PartsCatalog partsCatalog = partsCatalogRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(partsCatalogDTO, partsCatalog);
    ...
    private PartsCatalogDTO mapToDTO(final PartsCatalog partsCatalog,
            final PartsCatalogDTO partsCatalogDTO) {
    ...
    private PartsCatalog mapToEntity(final PartsCatalogDTO partsCatalogDTO,
