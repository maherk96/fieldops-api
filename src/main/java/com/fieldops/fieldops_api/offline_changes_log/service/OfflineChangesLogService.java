...
public class OfflineChangesLogService {
    ...
    public OfflineChangesLogService(final OfflineChangesLogRepository offlineChangesLogRepository,
    ...
    public List<OfflineChangesLogDTO> findAll() {
        final List<OfflineChangesLog> offlineChangesLogs = offlineChangesLogRepository.findAll(Sort.by("id"));
    ...
    public OfflineChangesLogDTO get(final UUID id) {
        return offlineChangesLogRepository.findById(id)
                .map(offlineChangesLog -> mapToDTO(offlineChangesLog, new OfflineChangesLogDTO()))
    ...
    public void update(final UUID id, final OfflineChangesLogDTO offlineChangesLogDTO) {
        final OfflineChangesLog offlineChangesLog = offlineChangesLogRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(offlineChangesLogDTO, offlineChangesLog);
    ...
    private OfflineChangesLogDTO mapToDTO(final OfflineChangesLog offlineChangesLog,
            final OfflineChangesLogDTO offlineChangesLogDTO) {
        ...
        offlineChangesLogDTO.setUser(offlineChangesLog.getUser() == null ? null : offlineChangesLog.getUser().getId());
        return offlineChangesLogDTO;
    }

    private OfflineChangesLog mapToEntity(final OfflineChangesLogDTO offlineChangesLogDTO,
        ...
        final User user = offlineChangesLogDTO.getUser() == null ? null : userRepository.findById(offlineChangesLogDTO.getUser())
    ...
    public void on(final BeforeDeleteUser event) {
        ...
        final OfflineChangesLog userOfflineChangesLog = offlineChangesLogRepository.findFirstByUserId(event.getId());
