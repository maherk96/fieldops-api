package com.fieldops.fieldops_api.customer.rest;

import com.fieldops.fieldops_api.customer.model.CustomerDTO;
import com.fieldops.fieldops_api.customer.service.CustomerService;
...
public class CustomerResource {
  ...
  public ResponseEntity<UUID> updateCustomer(
      @PathVariable(name = "id") final UUID id, @RequestBody @Valid final CustomerDTO customerDTO) {
