...
public class AuditLogService {
    ...
    private AuditLogDTO mapToDTO(final AuditLog auditLog, final AuditLogDTO auditLogDTO) {
        ...
        auditLogDTO.setChangedByUser(auditLog.getChangedByUser() == null ? null : auditLog.getChangedByUser().getId());
        return auditLogDTO;
    }
    ...
    private AuditLog mapToEntity(final AuditLogDTO auditLogDTO, final AuditLog auditLog) {
        ...
        final User changedByUser = auditLogDTO.getChangedByUser() == null ? null : userRepository.findById(auditLogDTO.getChangedByUser())
    ...
    public void on(final BeforeDeleteUser event) {
        ...
        final AuditLog changedByUserAuditLog = auditLogRepository.findFirstByChangedByUserId(event.getId());
